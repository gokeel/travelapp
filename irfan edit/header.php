        ...
        <div class="row-fluid">
          <nav class="nav-menu">
            ...
            <ul id="header-menu" class="menu">
              ...
              <li> <a href="http://hellotraveler.co.id/dev/index.php/webfront/promo">Promo</a></li>
              <li> <a href="http://hellotraveler.co.id/dev/index.php/webfront/hotel">Hotel</a> </li>
              <li> <a href="http://hellotraveler.co.id/dev/index.php/webfront/paketwisata">Paket Wisata</a> </li>
              <li> <a href="http://hellotraveler.co.id/dev/index.php/webfront/tentang">Tentang Kami</a></li>
              <li> <a href="http://hellotraveler.co.id/dev/index.php/webfront/agen">Keagenan</a></li>
              <li> <a href="http://hellotraveler.co.id/dev/index.php/webfront/registrasi">Registrasi agen</a></li>
              <li> <a href="<?php echo base_url('');?>index.php/admin">Login</a></li>
			  <li><a href="http://hellotraveler.co.id/dev/index.php/webfront/kontak">Kontak</a> </li>
            </ul>
          </nav>
          <!-- Menu Search Form 
        ...
        <div class="container">
          <div class="row-fluid">
            ...
            <div class="header-contact button"> <a href="#">
              <ul class="clearfix">
                <li class="phone-number"> <a href="http://hellotraveler.co.id/dev/index.php/webfront/kontak"><i class="icon-phone"></i> +62(21) - 86603475 </li>
