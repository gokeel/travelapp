...
<div class="page-title">
                        <div class="container">
                            <div style="float:left; margin-right:10px;">
                                <img src="<?php echo IMAGES_DIR;?>/partner.jpg" alt="Page Title" width="150"/>
                            </div>
                            <div class="page-title-content">
                                <h1>Keagenan</h1>
                                <p class="page-description">
									Keagenan dalam hellotraveler menawarkan berbagai keunggulan dan keleluasaan dalam memulai bisnis travel agen. kami mengucapkan selamat bergabung. Anda juga dapat langsung mengunjungi kantor kami.
								</p>
                            </div>
                        </div>
                    </div>
...
<div>
            ...
            <div class="row-fluid paket-wisata">
             <div> <span class="style1">CARA PENDAFTARAN </span><br />
               <br />
Untuk bergabung sebagai mitra hellotraveler sangatlah mudah hanya dengan 4 langkah berikut maka Anda sudah bergabung:<br /><br />
<ul>
<li><strong>Isi Formulir</strong><br />
Isi formulir pendaftaran sesuai data diri Anda. Pastikan formulir diisi dengan data yang benar untuk kemudahan transaksi Anda dan untuk keperluan korespondensi selanjutnya. Data validasi akan dikirim ke email Anda.</li>
<br /><li><strong>Pembayaran</strong><br />
Silahkan lakukan pembayaran dengan melalui bank yang telah di Tunjuk oleh Hello Traveler berdasarkan sejumlah nilai yang telah kami kirimkan melalui email dan lakukan konfirmasi pembayaran melalui email setelah Anda melakukan pembayaran.</li>
<br /><li><strong>Validasi</strong><br />
Kami akan memvalidasi kesesuaian data dan pembayaran yang Anda kirimkan dan segera akan mengirimkan User ID dan Password ke email Anda.</li>
<br /><li><strong>Login</strong><br />
Melalui User ID dan Password yang kami kirim, Anda dapat melakukan login dan bertransaksi melalui sistem HelloTraveler dari web http://hellotraveler.co.id.</li>
</ul>
...
<span class="style1">PEMBAGIAN KEUNTUNGAN</span><br />
<br />
Keraguan sering muncul sebelum memutuskan bergabung dengan penyedia jasa bisnis online, Sebelum memutuskan bergabung bersama HELLO TRAVELER INDONESIA, ada baiknya anda membandingkan terlebih dahulu dengan vendor vendor penyedia layanan online lainnya. OK... mari ke menengok ke belakang sebentar kemudian bandingkan dengan yang terbaru dari HELLO TRAVELER INDONESIA sebagai Portal travel Agent dengan Konsep One Stop Travel Service :<br />
<br />
Kenyataan pertama : Untuk bergabung harus membayar sejumlah uang jaminan Dalam jangka waktu kontrak yang tidak bisa di kembalikan alias "hangus", ada batasan tertentu dalam deposit yang tidak bisa di belanjakan, biaya bulanan dengan berbagai ilustrasi pengeluaran lainnya dengan alasan sewa system kek, maintenant kek..... Tetapiiii masih ada hal yang menguntungkan yaitu memberikan full komisi airline untuk mitra agen.
Kenyataan kedua : Regitrasi fee yang tinggi untuk bergabung, tetapi setiap pembelian tiket, komisi masih harus di bagi dengan perbandingan prosentasi.<br />
<br />
Kenyataan ketiga : Sering kali bagi yang deposit tidak bisa "me-nol-kan" depositnya. contoh : anda deposit 500.000, kemudian anda issued tiket sebesar 300.000. berarti sisa deposit anda sebesar 200.000. Kemudian anda akan issued lagi sebesar 235.000.... nah ini masalahnya, apakah anda bisa transfer 35.000 saja untuk melengkapi deposit anda yang tersisa 200.000 di rekening vendor?
Kenyataan ke empat : ini yang sedikit tidak adil, anda harus membayar untuk bergabung, dan komisinya di bagi dengan vendor. KOK pada mau ya.....!!!!<br /><br />
Kenyataan kelima : Pada dasarnya semua system yang di tawarkan vendor hampir sama, mencoba meninggalkan cara lama yang konvensional di ganti dengan system yang semi instan sampai full instan, semua penawaran system pasti akan ada konsekwensi yang harus di keluarkan oleh mitra pengguna, tinggal bagaimana mitra pengguna bisa bijak untuk memilih dan memahami system tersebut, ditambah lagi dengan jaringan koneksi internet yang berbeda di tiap daerah dalam mengakses sytem tersebut sehingga system tersebut berjalan lambat atau cepat.<br /><br />
HELLO TRAVELER INDONESIA memberikan kenyataan : Biaya registrasi sangat kecil, Tidak ada kontrak pemakaian system, Tidak ada biaya bulanan, Deposit mitra hingga Rp. 0 , komisi dari sub agen anda bisa di tarik dalam bentuk cash sewaktu waktu, system reservasi dan konfirmasi berbasis web, Dan yang lebih parah lagi, kami memberikan NTA ( Net To Agent ) untuk beberapa airine. dan masih banyak fitur fitur lainnya yang kami tawarkan, Serta HELLO TRAVELER INDONESIA memberikan banyak pilihan kemitraan dengan biaya registrasi yang beragam dan keuntungan yang beragam juga.<br /><br />

<span class="style1">PENGGUNAAN SYSTEM</span><br />
<ul>
<li>Penggunaan system booking hello traveler Indonesia sangatlah Mudah dan sangat Familiar hanya 1 kali pencarian rute Langsung memberikan daftar harga tiket Termurah saat itu di semua maskapai penerbangan sesuai jadwal penerbangan yang diinginkan</li>
<li>Tak perlu bolak-balik melakukan pengecekan harga tiket antara satu maskapai ke maskapai penerbangan lainnya </li>
<li>Otomatisasi proses
	<ol>
		<li>Sistem otomatis menghitung komisi dengan akurat </li>
		<li>Tak ada proses menunggu konfirmasi pembayaran</li>
		<li>Tak perlu menunggu untuk issue tiket karena Agen dapat mencetak tiket sendiri, tiket langsung dikirimkan via email</li>
	</ol>
</li>
<li>Memperbesar kemungkinan volume pemesanan tiket yang lebih banyak dalam satu hari. Dengan sistem yang lebih cepat dan simpel, Anda dapat melakukan lebih banyak transaksi dalam satu hari</li>
</ul>
