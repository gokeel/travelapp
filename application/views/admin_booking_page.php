			...
			var table = new Y.DataTable({
				columns: [
					...
					{key:"payment_status", label:"Status Pembayaran"},
					{
						key:"order_id", 
						label: "Checkout",
						formatter:'<a href="<?php echo base_url();?>index.php/admin/proceed_order/flight/{value}" style="color:red"><button>Proses Checkout</button></a>',
						allowHTML: true
					},
					{
						key:"order_id", 
			...
			var table = new Y.DataTable({
				columns: [
					...
					{key:"payment_status", label:"Status Pembayaran"},
					{
						key:"order_id", 
						label: "Action",
						formatter:'<a href="<?php echo base_url();?>index.php/admin/proceed_order/train/{value}" style="color:red"><button>Proses Checkout</button></a>',
						allowHTML: true
					},
					{
						key:"order_id", 
			...
			var table = new Y.DataTable({
				columns: [
					...
					{key:"payment_status", label:"Status Pembayaran"},
					{
						key:"order_id", 
						label: "Action",
						formatter:'<a href="<?php echo base_url();?>index.php/admin/proceed_order/hotel/{value}" style="color:red"><button>Proses Checkout</button></a>',
						allowHTML: true
					},
					{
						key:"order_id", 
