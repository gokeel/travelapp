  ...
  <!--content--> 
	...
	<div class="frametab">
		<form class="myform" id="edit_form">
			<h3 style="margin:5px 0 5px 5px;">Ubah Akun Yahoo! Messenger</h3>
			<table cellpadding="5"  id="table-modify"   cellspacing="0" border="0px" bgcolor="#FFFFFF" class="myTable" >
				<tr class="editTR" >
					<td class="tdTitle">Tipe</td>
					<td><input name="tipe" id="tipe" type="text" value="" size="60"></td>
				</tr>
				<tr class="editTR" >
					<td class="tdTitle">Akun</td>
					<td><input name="akun" id="akun" type="text" value="" size="60"></td>
				</tr>
			</table>
			<div id="status"></div>
			<div class="formFooter">
				<input class="mybutton" style="float:left" name="dbproses" type="button" value="Cancel" onclick="document.location.href='<?php echo base_url();?>index.php/admin/setting_yahoo_page';" />
...
<script>
	...
	$( window ).load(function() {
	 <?php
		...
		echo 'load_data_ym("'.base_url().'index.php/admin/ym_details/'.$id.'");';
	 ?>	
	});
	$(document).ready(function() {
		$('#edit_data').click(function(event) {
			...
			$.ajax({
				type : "GET",
				url: "<?php echo base_url().'index.php/admin/ym_edit/'.$id;?>",
				data: form,
				cache: false,
				dataType: "json",
				success:function(data){
