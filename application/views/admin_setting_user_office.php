...
<div id="content"  style="min-height:400px;"> 
  <div class="frametab">
		...
		<div id="tabs">
			<ul>
				<li><a href="#tabs-1">Master Admin</a></li>
				<li><a href="#tabs-2">Ticketing</a></li>
				<li><a href="#tabs-3">Owner</a></li>
				<li><a href="#tabs-4">Accounting</a></li>
				<li><a href="#tabs-5">Promosi</a></li>
			</ul>
			<div>
				<div id="tabs-1">
					<button id="add-admin">Tambah Data</button>
					<div id="list-admin"></div>
				</div>
				<div id="tabs-2">
					<button id="add-ticketing">Tambah Data</button>
					<div id="list-ticketing"></div>
				</div>
				<div id="tabs-3">
					<button id="add-owner">Tambah Data</button>
					<div id="list-owner"></div>
				</div>
				<div id="tabs-4">
					<button id="add-accounting">Tambah Data</button>
					<div id="list-accounting"></div>
				</div>
				<div id="tabs-5">
					<button id="add-promosi">Tambah Data</button>
					<div id="list-promosi"></div>
				</div>
			</div>
		</div>
